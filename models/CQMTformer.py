...
import torch
from layers.Tools.Embed import DataEmbedding_inverted
...
class Model(nn.Module):
    ...
    def __init__(self, configs, **kwargs):
        ...
        self.patchmamba = PatchModel(self.c_in, self.pred_len, self.patch_len, configs.d_state, self.d_model, configs.dropout, model='mamba', flatten='p')
...
class PatchModel(nn.Module):
    def __init__(self, c_in, pred_len, patch_len, d_state, d_model, dropout, model:str, flatten:str):
        super().__init__()
