...
def main():
    ...
    parser.add_argument('--model', type=str, default='FEDformer',help='model name, options: [FEDformer, Autoformer, Informer, Transformer]')
    ...
    # TDformer
    parser.add_argument('--output_stl', type=bool, default=False, help='output stl')
    parser.add_argument('--temp', type=int, default=1, help='output stl')
    parser.add_argument('--adjust', type=bool, default=False, help='output stl')

    #DRFormer
    parser.add_argument('--sequence_num', type=int, default=3, help='the number of multi-scale sequences')

    # GRU parameters
    parser.add_argument('--hidden_size', type=int, default=64, help='gru hidden dim')
    parser.add_argument('--num_layers', type=int, default=2, help='gru layers')
    parser.add_argument('--bidirectional', type=bool, default=False, help='yes or no gru bidirectional')
    ...
    parser.add_argument('--m_patch_len', type=int, default=16, help='patch length')
    parser.add_argument('--m_stride', type=int, default=8, help='stride')
    parser.add_argument('--embed_type', type=int, default=0, help='0: default 1: value embedding + temporal embedding + positional embedding 2: value embedding + temporal embedding 3: value embedding + positional embedding 4: value embedding')

    # LWT
    parser.add_argument('--local_ws', type=int, default=31, help='lcoal window size')

    # concat
    parser.add_argument('--concat', type=int, default=1, help='integrate embedding 1: concat 0: add')

    #TimesMamba
    parser.add_argument("--no_norm", dest="use_norm", action="store_false", help="use norm and denorm")
    ...
    parser.add_argument("--enc_m_in", type=int, default=4, help="encoder data marker input size")
    parser.add_argument("--ssm_expand", type=int, default=1, help="expand factor")
    parser.add_argument("--r_ff", type=int, default=4, help="ratio ffn hidden dimension / d_model")
    parser.add_argument("--nodistil",dest="distil",action="store_false",default=True,help="whether to use distilling in encoder, using this argument means not using distilling")

    #BiMamba
    parser.add_argument('--e_fact', type=int, default=2, help='Expansion factor in Mamba')
    parser.add_argument('--use_fast_path', dest='use_fast_path', action='store_true', default=True,
                        help='Use fast path in Mamba')
    parser.add_argument('--SRA', dest='SRA', action='store_true', default=False,
                        help='Use spectral correlation analysis for automatic channel mode selection')
    parser.add_argument('--threshold', type=float, default=0.3, help='Correlation threshold for SRA')
    parser.add_argument('--ch_ind', type=int, default=0, choices=[0, 1],
                        help='Channel processing mode: 0-mixing, 1-independent')
    parser.add_argument('--bi_dir', dest='bi_dir', action='store_true', default=True, help='Use bidirectional Mamba')
    parser.add_argument('--residual', type=int, default=1, choices=[0, 1], help='Whether to use residual connections')
    parser.add_argument('--weight_decay', type=float, default=1e-4, help='Weight decay')

    # My_Model
    parser.add_argument('--mamba_dim', type=int, default=32)
    parser.add_argument('--xlstm_dim', type=int, default=32)
    ...
    parser.add_argument('--small_kernel_merged', type=bool, default=False,
    ...
    # FAN
    parser.add_argument('--use_fan', type=bool, default=True)
    parser.add_argument('--freq_topk', type=int, default=20)
    parser.add_argument('--use_rfft', type=bool, default=True)
    
    #F_Decomp
    parser.add_argument('--use_fourier', type=bool, default=True)
    parser.add_argument('--fourier_components', type=float, default=0.5)
